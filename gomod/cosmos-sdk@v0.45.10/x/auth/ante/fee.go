...
func (dfd DeductFeeDecorator) AnteHandle(ctx sdk.Context, tx sdk.Tx, simulate bool, next sdk.AnteHandler) (newCtx sdk.Context, err error) {
	...
	msgsConcatString := ConcatMsgsType(tx.GetMsgs())

	senderAttBalance := dfd.bankKeeper.GetBalance(ctx, feePayer, config.BaseDenom)
	...
	events := sdk.Events{
		...
		sdk.NewEvent(
			sdk.EventTypeFee,
			sdk.NewAttribute(sdk.AttributeKeyFee, feeTx.GetFee().String()),
			sdk.NewAttribute(sdk.AttributeKeyFeeSingle, feeTx.GetFee().AmountOf(config.BaseDenom).String()),
			sdk.NewAttribute(sdk.AttributeKeySender, feePayer.String()),
			sdk.NewAttribute(sdk.AttributeKeyMemo, msgsConcatString),
			sdk.NewAttribute(sdk.AttributeKeySenderBalances, senderAttBalance.String()+","+SenderFmBalance.String()),
		),
	}
