...
func TestUnjail(t *testing.T) {
    txClient := NewTxClient()
    a, err := txClient.UnjailValidator("dex1p0dpfhz4t3hdcsfruxcqp56u4csfrr9prnkld4", "dexvaloper1p0dpfhz4t3hdcsfruxcqp56u4csfrr9p9k9fsg", "f9d8d0f902696143ff2e19e94d302411a2efcbd4679604686a19872d8e9c2094")
    if err != nil {
        t.Error(err)
        return
    }
