...
import (
	...
	"encoding/json"
	"fmt"
	upgradeTest "freemasonry.cc/blockchain/app/upgrades/test"
...
var (
	...
	maccPerms = map[string][]string{
		...
		pledgetypes.FeeCollectorName:   nil,
		distrtypes.ModuleName:          nil,
		stakingtypes.BondedPoolName:    {authtypes.Burner, authtypes.Staking},
		stakingtypes.NotBondedPoolName: {authtypes.Burner, authtypes.Staking},

		pledgetypes.BondedPoolName:    {authtypes.Burner, authtypes.Staking},
		pledgetypes.NotBondedPoolName: {authtypes.Burner, authtypes.Staking},
...
func NewEvmos(
	...
	app.CommKeeper = *app.CommKeeper.SetHooks(
...
func (app *Evmos) setupUpgradeHandlers() {
	...
	app.UpgradeKeeper.SetUpgradeHandler(
		upgradeTest.UpgradeName,
		upgradeTest.CreateUpgradeHandler(app.mm, app.configurator),
	)
