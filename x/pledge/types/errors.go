...
var (
	...
	//dist
	ErrEmptyWithdrawAddr       = sdkerrors.Register(ModuleName, 40, "withdraw address is empty")
	ErrEmptyDelegationDistInfo = sdkerrors.Register(ModuleName, 41, "no delegation distribution info")
	ErrNoValidatorDistInfo     = sdkerrors.Register(ModuleName, 42, "no validator distribution info")
	ErrNoValidatorCommission   = sdkerrors.Register(ModuleName, 43, "no validator commission to withdraw")
	ErrSetWithdrawAddrDisabled = sdkerrors.Register(ModuleName, 44, "set withdraw address disabled")
	ErrBadDistribution         = sdkerrors.Register(ModuleName, 45, "community pool does not have sufficient coins to distribute")
	ErrInvalidProposalAmount   = sdkerrors.Register(ModuleName, 46, "invalid community pool spend proposal amount")
	ErrEmptyProposalRecipient  = sdkerrors.Register(ModuleName, 47, "invalid community pool spend proposal recipient")
	ErrNoValidatorExists       = sdkerrors.Register(ModuleName, 48, "validator does not exist")
	ErrNoDelegationExists      = sdkerrors.Register(ModuleName, 49, "delegation does not exist")
	ErrEmptyProposalDelegate   = sdkerrors.Register(ModuleName, 50, "invalid proposal delegate")
	ErrProposalDelegate        = sdkerrors.Register(ModuleName, 51, "The proposal is invalid")

	ErrPledgeFeeTransfer = sdkerrors.Register(ModuleName, 52, "pledge fee transfer error")
	ErrPledgeFeeBurn     = sdkerrors.Register(ModuleName, 53, "pledge fee burn error")
	ErrPledgeFeeGateway  = sdkerrors.Register(ModuleName, 54, "pledge fee gateway error")
	ErrPledgeFeeDpos     = sdkerrors.Register(ModuleName, 55, "pledge fee dpos error")
	ErrPledgeDelegate    = sdkerrors.Register(ModuleName, 56, "pledge delegate error")
	ErrDevideError       = sdkerrors.Register(ModuleName, 57, "error devide")
	ErrPledgeLimit       = sdkerrors.Register(ModuleName, 58, "pledge amount too low")
	ErrGetGatewayInfo    = sdkerrors.Register(ModuleName, 59, "get gateway info error")
	ErrValidatotStatus   = sdkerrors.Register(ModuleName, 60, "validator status error")
	ErrAddressFormat     = sdkerrors.Register(ModuleName, 61, "address format error")
	ErrGetAllPledge      = sdkerrors.Register(ModuleName, 62, "get all pledge error")
)
